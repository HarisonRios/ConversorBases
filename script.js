...
function converterCaracterAscii() {
    ...
    div_output.innerHTML += "<p>Decimal: " + decimal + '</p><br>';
    div_output.innerHTML += "<p>Binário: " + decimal.toString(2) + '</p><br>';
    div_output.innerHTML += "<p>Hexadecimal: " + decimal.toString(16) + '</p><br>';
    div_output.innerHTML += "<p>Octal: " + decimal.toString(8) + '</p><br>';
}
